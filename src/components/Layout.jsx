  ...
  return (
    <div className={`flex min-h-screen w-full font-industrial transition-colors duration-500 ${userType === 'student' ? 'bg-slate-50' : 'bg-industrial-100'}`}>
      ...
      <main className="flex-1 ml-64 p-5">
        <header className="flex justify-between items-center mb-4 bg-white/50 backdrop-blur-md p-4 rounded-3xl border border-white/20 shadow-sm">
          <div>
          ...
          >
            ...
            <div className={`w-12 h-12 rounded-2xl flex items-center justify-center border-2 transition-all overflow-hidden ${userType === 'student' ? 'bg-indigo-50 border-indigo-100 group-hover:border-indigo-500' : 'bg-industrial-100 border-industrial-300 group-hover:border-safety-blue shadow-sm'}`}>
              <img 
